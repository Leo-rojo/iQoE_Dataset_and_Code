...
for metric in ['mae','rmse']:
    main_path_for_save_fig = '../output_data'
    ...
    for ss in group_dist:
        #scores=np.load('input_data_rigsvsrnd/'+ss+'_'+metric+'_each_user.npy')
        #print(scores)
    ...
    # # plt.xlim(0, 25)
    # plt.show()
    plt.savefig('../'+metric+'_ECDF_dashed.pdf', bbox_inches='tight')
    plt.savefig('../'+metric + '_ECDF_dashed.png', bbox_inches='tight')
    plt.close()