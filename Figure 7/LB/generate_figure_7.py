...
os.chdir('scripts')
os.system('python Generate_features_and_scores.py')
print('features and scores generated')
os.chdir('..')
...
#split in groups
baselines_all_users_score=np.load('output_data/baselines_scores.npy')
test_scores_all_users=np.load('output_data/test_scores.npy')
#merge them
...
identifiers=np.load('output_data/identifiers_order.npy')
...
for group_n in group_division:#[1,2,4,8,16,32]:
    ...
    #ssim
    x_tr=np.load('output_data/features_qoes_train/feat_ssim.npy')
    x_test=np.load('output_data/features_qoes_test/feat_ssim.npy')
    y_test_all_users=np.load('output_data/test_scores.npy')
    ...
    #ftw
    x_tr=np.load('output_data/features_qoes_train/feat_ftw.npy')
    x_test=np.load('output_data/features_qoes_test/feat_ftw.npy')
    y_test_all_users=np.load('output_data/test_scores.npy')
    y = mos_for_training
    ...
    #videoatlas
    x_tr=np.load('output_data/features_qoes_train/feat_va.npy')
    x_test=np.load('output_data/features_qoes_test/feat_va.npy')
    y_test_all_users=np.load('output_data/test_scores.npy')
    y=mos_for_training
    ...
    #psnr
    x_tr=np.load('output_data/features_qoes_train/feat_psnr.npy')
    x_test=np.load('output_data/features_qoes_test/feat_psnr.npy')
    y_test_all_users=np.load('output_data/test_scores.npy')
    y=mos_for_training
    a, b, c = fit_linear(x_tr, y)
    # calculate mae and rmse of the model for the user in index
    ...
    #bitrate
    x_tr=np.load('output_data/features_qoes_train/feat_bit.npy')
    x_test=np.load('output_data/features_qoes_test/feat_bit.npy')
    y_test_all_users=np.load('output_data/test_scores.npy')
    y=mos_for_training
    a, b, c = fit_linear(x_tr, y)
    # calculate mae and rmse of the model for the user in index
    ...
    #logbit
    x_tr=np.load('output_data/features_qoes_train/feat_logbit.npy')
    x_test=np.load('output_data/features_qoes_test/feat_logbit.npy')
    y_test_all_users=np.load('output_data/test_scores.npy')
    y=mos_for_training
    a, b, c = fit_linear(x_tr, y)
    # calculate mae and rmse of the model for the user in index
    ...
    #vmaf
    x_tr=np.load('output_data/features_qoes_train/feat_vmaf.npy')
    x_test=np.load('output_data/features_qoes_test/feat_vmaf.npy')
    y_test_all_users=np.load('output_data/test_scores.npy')
    y=mos_for_training
    a, b, c = fit_linear(x_tr, y)
    # calculate mae and rmse of the model for the user in index
    ...
    #sdn
    x_tr=np.load('output_data/features_qoes_train/feat_sdn.npy')
    x_test=np.load('output_data/features_qoes_test/feat_sdn.npy')
    y_test_all_users=np.load('output_data/test_scores.npy')
    y=mos_for_training
    a, b, c = fit_linear(x_tr, y)
    # calculate mae and rmse of the model for the user in index
