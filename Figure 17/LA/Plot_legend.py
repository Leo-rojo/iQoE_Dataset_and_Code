...
plt.plot(a, [1,2,3,4,5,6,7,8], stile[0],color ='r', linewidth=7,label='50 experiences')
plt.plot(b, [1,2,3,4,5,6,7,8], stile[1],color =colori[2], linewidth=7,label='75 experiences')
plt.plot(c, [1,2,3,4,5,6,7,8], stile[2],color =colori[0],linewidth=7,label='100 experiences')
