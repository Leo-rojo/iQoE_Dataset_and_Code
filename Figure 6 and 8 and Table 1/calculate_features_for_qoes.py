...
df.to_excel('scores_more_users_train.xlsx', index=False)
df = pd.DataFrame(videos_more_users)
df.to_excel('videos_more_users_train.xlsx', index=False)
...
df.to_excel('scores_more_users_test.xlsx', index=False)
df = pd.DataFrame(videos_more_users_test)
df.to_excel('videos_more_users_test.xlsx', index=False)
