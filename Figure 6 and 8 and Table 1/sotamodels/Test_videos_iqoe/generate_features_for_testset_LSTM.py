...
import numpy as np
import csv
#insert path to your folder Figure 6 and 8 and Table 1/sotamodels/Test_videos_iqoe')
folder_videos_chunked='../../Subjective_assesment_iQoE_implementation/video_generations/Video_preparation/mkvfiles' #insert the complete path to mkvfiles folder
nr_chunks=4
nr_feat_ec=10
chunk_length=2
