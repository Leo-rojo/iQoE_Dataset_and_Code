...
leg = ['bit', 'logbit', 'psnr', 'ssim', 'vmaf', 'FTW', 'SDNdash', 'videoAtlas']
metric='mae'
...
df.to_excel('gain_factors_mae_all_median_personalized.xlsx')
...
for i in range(nr_users):
    ...
    gain_factors_rmse=[]
    #print('user',identifier_ordered_by_name[i])
    for each_model in pers_rmses[i]:
...
df_rmse.to_excel('gain_factors_rmse_all_median_personalized.xlsx')
