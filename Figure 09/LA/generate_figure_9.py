...
import os
#insert path to your folder Figure 09
...
all_features=[]
#collect features and scores of real raters
...
###calcuate features for real exp for each real raters and scores
#scores
us_scores_vectors=[]
...
models_folder='input_data/Fitted_models_without_logistic'
...
#all_us_f[user][model] #model=0 and user=0 means that we have 120 group of 3 feat to make score the bitrate synthetic raters
