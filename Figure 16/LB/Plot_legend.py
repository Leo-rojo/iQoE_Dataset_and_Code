...
plt.bar(c, [1,2,3,4,5,6,7,8], color=colori[2], width=barWidth, linewidth=0, label='G', align='edge')
plt.bar(d, [1,2,3,4,5,6,7,8], color=colori[8], width=barWidth, linewidth=0, label='V',align='edge')
plt.bar(e, [1,2,3,4,5,6,7,8], color=colori[7], width=barWidth, linewidth=0, label='R',align='edge')
...
plt.bar(m, [1,2,3,4,5,6,7,8], color='darkblue', width=barWidth, linewidth=0, label='P',align='edge')
plt.bar(n, [1,2,3,4,5,6,7,8], color=colori[5], width=barWidth, linewidth=0, label='L',align='edge')
plt.bar(o, [1,2,3,4,5,6,7,8], color=colori[0], width=barWidth, linewidth=0, label='MOS-based iQoE', align='edge')
plt.legend(loc = 'upper left',ncol=12,frameon=False,fontsize=60,handletextpad=0.1)
# create a second figure for the legend
figLegend = pylab.figure(figsize = (20,10),dpi=100)

h,l=ax.get_legend_handles_labels()
# produce a legend for the objects in the other figure
pylab.figlegend(*ax.get_legend_handles_labels(), loc = 'upper left',ncol=12,frameon=False,fontsize=100)
