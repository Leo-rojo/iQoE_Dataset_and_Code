...
def each_user(nr_chunks, rs, u, model, regr_choosen,n_queries):
    ...
    X_pool_cluster,X_pool_gs,X_pool_comm,X_pool_gsio=X_pool.copy(),X_pool.copy(),X_pool.copy(),X_pool.copy()
    y_pool_cluster,y_pool_gs,y_pool_comm,y_pool_gsio=y_pool.copy(),y_pool.copy(),y_pool.copy(),y_pool.copy()
    ...
    # folders for metrics
    scores100=[scores_cluster,scores_gs,scores_comm,scores_gsio]
    lcc100=[lccs_cluster,lccs_gs,lccs_comm,lccs_gsio]
    rmse100=[rmses_cluster,rmses_gs,rmses_comm,rmses_gsio]
    maes100=[maes_cluster,maes_gs,maes_comm,maes_gsio]
    knd100=[knds_cluster,knds_gs,knds_comm,knds_gsio]
    srcc100=[srccs_cluster,srccs_gs,srccs_comm,srccs_gsio]
