...
for nr_dev,device in enumerate(devices):
    ...
    np.save('../input_data/features_'+device+'.npy',all_features)
    np.save('../input_data/users_scores_'+device+'.npy',users_score)
    np.save('../input_data/mos_scores_'+device+'.npy',hdtv_moses)