...
for metric in ['mae','rmse']:
            ...
            for shuffle in [13,34,42,70,104]:
                ...
                for u in range(32):
                    for QoE_model in ['bit','logbit','psnr','ssim','vmaf','FTW','SDNdash','videoAtlas']:
                        main_path='../output_data/'+regr_choosen + '_results_qn_' + str(n_queries) + '_nr_ch_7_1'+'rigs'
        ...
        for kind_reg in range(4):
            ...
            conta+=1
        np.save('../values' + metric, save_distributions)
        ...
        # plt.xlim(0, 25)
        # plt.show()
        plt.savefig('../'+ metric +'_Rigs.pdf', bbox_inches='tight')
        plt.close()
