...
for fold in os.listdir('../input_data/users'):
    if fold.split('_')[0]=='user':
        ...
        ###############################################################
        collect_sumbit = np.load('../output_data/features_qoes_train/feat_bit.npy')
        collect_sumpsnr = np.load('../output_data/features_qoes_train/feat_psnr.npy')
        collect_sumssim = np.load('../output_data/features_qoes_train/feat_ssim.npy')
        collect_sumvmaf = np.load('../output_data/features_qoes_train/feat_vmaf.npy')
        collect_logbit = np.load('../output_data/features_qoes_train/feat_logbit.npy')
        collect_FTW = np.load('../output_data/features_qoes_train/feat_ftw.npy')
        collect_SDNdash = np.load('../output_data/features_qoes_train/feat_sdn.npy')
        collect_videoAtlas = np.load('../output_data/features_qoes_train/feat_va.npy')
        ...
        for idx_i,i in enumerate(l):
            ...
            if i == 'FTW':
                ...
                if not os.path.exists('../output_data/personalized_videoatlas'):
                    os.makedirs('../output_data/personalized_videoatlas')
                pickle.dump(fit_supreg(all_features, users_scores), open('../output_data/personalized_videoatlas/videoAtlas_user_' + identifier + '.pkl', 'wb'))
                collect_temp.append('../output_data/videoAtlas_user_' + identifier + '.pkl')
            else:
                collect_temp.append(fit_linear(all_features, users_scores))

            collect_all.append(collect_temp)
            #print(i)
        if not os.path.exists('../output_data/personalized_parameters'):
            os.makedirs('../output_data/personalized_parameters')
        np.save('../output_data/personalized_parameters/params_'+identifier,collect_all)
...
for fold in os.listdir('../input_data/users'):
    if fold.split('_')[0]=='user':
        ...
        collect_sumbit = np.load('../output_data/features_qoes_test/feat_bit.npy')
        collect_sumpsnr = np.load('../output_data/features_qoes_test/feat_psnr.npy')
        collect_sumssim = np.load('../output_data/features_qoes_test/feat_ssim.npy')
        collect_sumvmaf = np.load('../output_data/features_qoes_test/feat_vmaf.npy')
        collect_logbit = np.load('../output_data/features_qoes_test/feat_logbit.npy')
        collect_FTW = np.load('../output_data/features_qoes_test/feat_ftw.npy')
        collect_SDNdash = np.load('../output_data/features_qoes_test/feat_sdn.npy')
        collect_videoAtlas = np.load('../output_data/features_qoes_test/feat_va.npy')
        ...
        params=np.load('../output_data/personalized_parameters/params_'+identifier+'.npy',allow_pickle=True)
        for kind_of_models in models:
            if kind_of_models == 'bit':  # [s_bit,s_dif_bit,s_psnr,s_dif_psnr,s_ssim,s_dif_ssim,s_vmaf,s_dif_vmaf,s_bit_log,s_dif_bit_log,ave_st_FTW,nr_stall_FTW,s_reb]
                ...
                with open('../output_data/personalized_videoatlas/videoAtlas_user_'+identifier+'.pkl','rb') as handle:
...
np.save('../output_data/personalized_literature_qoe_mae_each_user.npy',maes)
np.save('../output_data/personalized_literature_qoe_rmse_each_user.npy',rmses)
